...
import javax.swing.JLabel;
	 ...
	 *  con un gráfico específico de ESTRELLA
	...
	public class JLabelEstrella extends JLabel {
		...
		public static final int RADIO_ESFERA_ESTRELLA = 17;  // Radio en píxels del bounding circle del ESTRELLA (para choques)
		...
		/** Construye y devuelve el JLabel del ESTRELLA con su gráfico y tamaño
		 */
		...
		public void setGiro( double gradosGiro ) {
			...
			// Y el gráfico del ESTRELLA apunta hacia arriba (en lugar de derecha OX)
